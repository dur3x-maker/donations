...
from app.schemas.user import ContributionProgressOut, LinkAnonymousContributions, OwnerDashboardOut, ProfileImpactOut, ProfileSummaryOut, UserAchievementOut, UserOut, UserProfileUpdateIn
from app.services.bank_account_service import get_bank_account_state
...
async def contribution_progress(
    ...
    bank_account = await get_bank_account_state(session, current_user.id)
    return ContributionProgressOut(
        ...
        can_open_bank_account=bank_account.can_open_bank_account,
        has_bank_account=bank_account.has_bank_account,
        bank_account_application_status=bank_account.application_status,
    )
